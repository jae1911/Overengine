...
export const SITE_DESCRIPTION: string = env.SITE_DESCRIPTION ?? 'The blog of Jae.';
export const SITE_COPYRIGHT: string = env.SITE_COPYRIGHT ?? 'CC BY-SA 4.0 Jae Lo Presti';
