...
export const generateListFromFile = (path: string, baseDomain: string, onlyIndex?: boolean, noIndex?: boolean, menuName?: string, isBlog?: boolean, tag?: string): readonly MenuList[] => {
...
export const generateBlogListTagged = (baseDomain: string, tag: string): string => {
